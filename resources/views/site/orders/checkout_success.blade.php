                                ...
                                <tr class="product">
                                    ...
                                    <div class="product-thumbnail">
                                        <div class="product-thumbnail-wrapper">
                                            <img class="product-thumbnail-image" alt="{{$detail->post->name}}" src="{{$detail->post->image->path}}" />
                                            </div>
                                            <span class="product-thumbnail-quantity" aria-hidden="true">{{$detail->qty}}</span>
                                        </div>
                                    </td>
                                    <td class="product-description">
                                    <span class="product-description-name order-summary-emphasis">{{$detail->post->name}}</span>
                                    ...
                                    <td class="product-price">
                                        ...
                                        @else
                                            <span class="order-summary-emphasis">Liên hệ</span>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
