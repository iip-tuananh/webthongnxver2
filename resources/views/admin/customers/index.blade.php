                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group custom-group">
                                            ...
                                            <select class="form-control" ng-model="form.status_id">
...
<script>
    let datatable = new DATATABLE('table-list', {
        ajax: {
            url: '/admin/customers/searchData',
        ...
        search_columns: [
            {data: 'keywords', search_type: "text", placeholder: "Mã hoặc tên khách hàng"},
        ],
    }).datatable;
    ...
    app.controller('Customers', function ($rootScope, $scope, $http) {
        $scope.loading = {};
        $scope.statues = @json(\App\Model\Common\Customer::STATUSES);
        $scope.form = {}
