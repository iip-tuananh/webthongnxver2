...
@section('content')
    <style>
        .dd3-content{justify-content:space-between;align-items:center}
        .home-flag{margin-right:6px;font-size:14px;vertical-align:middle}
        .home-flag.on{color:#16a34a}   /* xanh lá: hiển thị trang chủ */
        .home-flag.off{color:#94a3b8;opacity:.7} /* xám: không hiển thị */
            ...
            <div class="wrap bg-white">
              <div class="cf nestable-lists">
                <div class="dd" id="nestable">
                  ...
                  $thisRef['show_home_page'] = $data->show_home_page;
                  $thisRef['id'] = $data->id;
                  ...
                  $html = "<ol class=\"".$class."\" id=\"menu-id\">";
                    foreach($items as $key=>$value) {
                         $showHome = (int)($value['show_home_page'] ?? 0) === 1;
                        $homeIcon = $showHome
                            ? '<i class="fas fa-home home-flag on" title="Hiển thị trên trang chủ" aria-label="Hiển thị trên trang chủ"></i>'
                            : '<i class="fas fa-home home-flag off" title="Không hiển thị trên trang chủ" aria-label="Không hiển thị trên trang chủ"></i>';


                    $html.= '<li class="dd-item dd3-item" data-id="'.$value['id'].'">
                      <div class="dd-handle dd3-handle"></div>
                      <div class="dd3-content"> <span id="label_show'.$value['id'].'">'.$homeIcon.' '.$value['name'].'</span>
